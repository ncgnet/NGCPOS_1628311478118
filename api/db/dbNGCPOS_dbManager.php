...
function getConnection() {
	...
	global $db_NGCPOS_db_Url, $db_NGCPOS_db_User, $db_NGCPOS_db_Pass, $db_NGCPOS_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_NGCPOS_db_Url.";dbname=".$db_NGCPOS_db_DbName, $db_NGCPOS_db_User, $db_NGCPOS_db_Pass);
